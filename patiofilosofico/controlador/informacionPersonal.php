...
include '../modelo/estudiosAcademicos.php';
session_start();
$p = $_POST;
$s = $_SESSION;
$f = $_FILES;
...
//        $conn = conBD::conectar();
        $rutaMultimedia = "";
//        $rutaMultimedia = "user_" . $user->getId();
...
//            echo $_FILES['archivo']['name'];
            ...
            $rutaMultimedia = "../vista/Imagenes/perfil/user_" . $user->getId() . "." . end($extencion);
    ...
    else if ($p["oper"] == "eliminarInfoAcademica") {
        $idEstudio = $p["idInfoAcademico"];
        estudiosAcademicos::eliminarEstudio($idEstudio);
    }
} else {
