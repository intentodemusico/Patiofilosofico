...
<hr class="linea">
<section class="main container col-md-12 mb-5 p-5">
            ...
            <article class="row">
                <div class="col-6">
                    ...
                    <a href="#" class="thumb pull-left">
                        <img src="imagenes/grupofilo.jpeg" width="100%" alt="grupo FiloEn" > 
                    </a>

                </div>

                <div class="col-6 ">
                    <p class="text-justify">El grupo Filosofía y Enseñanza de la Filosofía es un grupo interinstitucional avalado por las Universidades Pedagógica Nacional, Antioquia, Cauca e Industrial de Santander. Actualmente conformado por investigadores de estas universidades y de la Universidad de Texas-Arlington-EEUU. <br><br>
                    ...
                    <h2 class="submen">¿Quiénes Somos?</h2>
                    <p class="texto">
                    ...
                    <br> <p class="letra">
                        Grupo Filosofía y Enseñanza de la Filosofía.<br>
                        Si quieres hablar con alguno de nuestros profesionales del grupo, puedes escribirnos al correo:

                        Email <br>
                        soporte.portalfiloen@gmail.com</p>
                    </p>

                    <form action="#1" onclick="cargarPagina('contactenos_comp.php', 'contenedorPrincipal', true)">
