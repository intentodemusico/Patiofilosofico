    ...
    <div class="row">
        ...
        while ($roww = mysqli_fetch_array($nombrecat)) {
            ...
            <a href="noticiacompleta.php?id=<?php echo $row['id']; ?>">
                <h2 class="primo"><?php echo $row['Titulo']; ?></h2>
            </a>
            ...
            <?php
                ...
                if(!$hayPublicacionesConCat){
                    ?><br><br><p>no hay publicaciones con esta categoría</p> <?php
                }
            }
            ?>
