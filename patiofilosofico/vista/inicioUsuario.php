...
<html lang="en" class="no-js">
    ...
    <body >
        ...
        <?php
        if ($usuario->getTipo_usuario() == "ADMINISTRADOR") {
        ?>       
            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left cbp-spmenu-open" id="cbp-spmenu-s1">
                ...
                <a href="#1" onclick="cargarPagina('inicioUsuario.php', 'contenedorPrincipal', true)"><i class="fa fa-user-circle"></i>Información personal</a>
                ...
                <a href="#22" class=" " onclick="cargarPagina('eventos.php', 'contenedorPrincipal', true)" ><i class="fa fa-calendar"></i><span class="hidden-md-down"> Eventos</span></a>
            ...
            ?>
             <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left cbp-spmenu-open" id="cbp-spmenu-s1">
                ...
                <a href="#1" onclick="cargarPagina('inicioUsuario.php', 'contenedorPrincipal', true)"><i class="fa fa-user-circle"></i>Información personal</a>
                <!--<a href="#2" onclick="cargarPagina('buscardorPerfiles.php', 'cuerpo-principal-perfil', true);"><i class="fa fa-users"></i><span class="text-menu-lateral"> Demás Perfiles</span></a>-->
                <a href="../vista/blogs/blog.php"><i class="fa fa-book"></i><span class="text-menu-lateral"> Mi Blog</span></a>
                <a href="#2" onclick="cargarPagina('grupos.php', 'cuerpo-principal-perfil', true);"><i class="fa fa-university"></i> <span class="text-menu-lateral">Comunidad</span></a>
                <!--<a href="#2"><i class="fa fa-comment"></i><span class="text-menu-lateral"> Chat</span></a>-->
                <a href="#22" class=" " onclick="cargarPagina('eventos.php', 'contenedorPrincipal', true)" ><i class="fa fa-calendar"></i><span class="hidden-md-down"> Eventos</span></a>
            ...
            <div class="container" id="cuerpo-principal-perfil">
                ...
                if (!isset($_GET["pag"])) {
                    ...
                    <form method="post" action="../controlador/informacionPersonal.php" class="" onsubmit="envioFormulario(this, 'resp', false);return false;">
                        ...
                        <div class="row mb-5">
                            <h4 class="col-12 ">Información Personal</h4>
                            ...
                            <div class="col-12 col-sm-8  row">
                                ...
                                <div class="col-12"><h4>Información de Contacto</h4></div>
                    ...
                    <div class="container-fluid">
                        <div class="row-flow"><h4>Información Académica</h4></div>
                        <?php
                        ...
                        <blockquote >
                            <form id="forminformacionAcademica" class="mt-sm-10" action="../controlador/informacionPersonal.php" onsubmit="envioFormularioMultiPart2('forminformacionAcademica', 'cont_estudioAcademico', true); return false;" method="post">
                                ...
                                <h5 >Nueva información académica</h5>
                                <div class="row">
                                    <div class="col-12 btn-group mt-2 ">
                                        <span class="input-group-text lb">Título: </span>
                                    ...
                                    <div class="col-12 col-md-8 btn-group mt-2">
                                        <span class="input-group-text lb">Institución: </span>
...
//                        print_r($infoAcademica);
                            if (count($infoAcademica) <= 0) {
                                ...
                                <blockquote style="width: 70%;margin: auto; border-color: orange; color: orange" >
                                    ...
                                    <p class="text-muted">No se han registrado datos académicos, si desea puede registrar los diferentes estudios realizados en su vida académica. </p>
                                </blockquote >
                                <?php
                            }
                            foreach ($infoAcademica as $info) {
                                ?>
                                <div class="row col-12 col-sm-10  offset-xs-0 offset-sm-1 mt-3 border-top" id="infoAcade<?php echo $info["idinformacion_academica"]; ?>">
                                    <div class="col-12"><button class=" btn btn-defauld close" title="Eliminar información acedmica" onclick="eliminarInfoAcademica(<?php echo $info["idinformacion_academica"]; ?> )"> <span aria-hidden="true">&times;</span></button></div>
            ...
            <script>
                ...
                function eliminarInfoAcademica(idInfoAcedemica) {
                    var datos = {idInfoAcademico: idInfoAcedemica, oper: 'eliminarInfoAcademica'};
                    $.ajax({
                        url:"../controlador/informacionPersonal.php" ,
                        type: "post",
                        data: datos,
                        success: function (result) {
                            console.log(result);
                            $("#infoAcade"+idInfoAcedemica).remove();
                            cerrarLoader();
                        },
                        error: function (e) {
                            console.log(e);
                            $("#infoAcade"+idInfoAcedemica).append("ha ocurrido un Error en el envio del formulario " + e);
                            cerrarLoader();
                        }
                    });
                }
